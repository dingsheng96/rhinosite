        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-transparent">
                    <h3 class="card-title">{{ __('modules.edit', ['module' => trans_choice('modules.submodules.package', 1)]) }}</h3>
                </div>

                <form action="{{ route('ecommerce.packages.update', ['package' => $package->id]) }}" method="post" role="form" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group table-responsive">
                                    @include('ecommerce.package.items', ['items' => $items])
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-footer bg-transparent text-md-right text-center">
                        <a role="button" href="{{ route('ecommerce.packages.index') }}" class="btn btn-light mx-2 btn-rounded-corner">
