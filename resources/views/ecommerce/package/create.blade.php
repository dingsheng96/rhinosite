        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-transparent">
                    <h3 class="card-title">{{ __('modules.create', ['module' => trans_choice('modules.submodules.package', 1)]) }}</h3>
                </div>

                <form action="{{ route('ecommerce.packages.store') }}" method="post" role="form" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group table-responsive">
                                    @include('ecommerce.package.items')
                                </div>
                            </div>
                        </div>
