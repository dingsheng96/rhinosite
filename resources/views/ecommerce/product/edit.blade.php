        ...
        <div class="col-12 col-md-6">
            <div class="card">
                ...
                <div class="card-body table-responsive">
                    @include('ecommerce.product.image')
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-header bg-transparent">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('ecommerce.products.attributes.create', ['product' => $product->id]) }}" role="button" class="btn btn-outline-primary btn-rounded-corner mx-2">
