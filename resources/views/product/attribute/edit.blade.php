        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-transparent">
                    <h3 class="card-title">{{ __('modules.edit', ['module' => trans_choice('labels.attribute', 1)]) }}</h3>
                </div>

                <form action="{{ route('products.attributes.update', ['product' => $product->id, 'attribute' => $attribute->id]) }}" method="post" enctype="multipart/form-data" role="form">
                    @csrf
                    @method('put')
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="sku" id="sku" class="form-control @error('sku') is-invalid @enderror" value="{{ old('sku', $attribute->sku) }}">
                                    @error('sku')
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="icheck-primary">
                                        <input type="checkbox" name="trial_mode" id="trial_mode" class="@error('trial_mode') is-invalid @enderror" {{ old('trial_mode', $attribute->trial_mode) ? 'checked' : null }}>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="icheck-primary">
                                        <input type="checkbox" name="recurring" id="recurring" class="@error('recurring') is-invalid @enderror" {{ old('recurring', $attribute->recurring) ? 'checked' : null }}>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="icheck-primary">
                                        <input type="checkbox" name="published" id="published" class="@error('published') is-invalid @enderror" {{ old('published', $attribute->published) ? 'checked' : null }}>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="stock_type" id="stock_type" class="form-control select2 @error('stock_type') is-invalid @enderror">
                                        ...
                                        <option value="{{ $type }}" {{ old('stock_type', $attribute->stock_type) == $type ? 'selected' : null }}>{{ Str::title($type) }}</option>
                                        @endforeach
                                    </select>
                                    @error('stock_type')
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="quantity" id="quantity" class="form-control @error('quantity') is-invalid @enderror" value="{{ old('quantity', $attribute->quantity) }}" min="0" step="1">
                                    @error('quantity')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="validity_type" id="validity_type" class="form-control select2 @error('validity_type') is-invalid @enderror">
                                        ...
                                        <option value="{{ $type }}" {{ old('validity_type', $attribute->validity_type) == $type ? 'selected' : null }}>{{ Str::title($type) }}</option>
                                        @endforeach
                                    </select>
                                    @error('status')
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="validity" id="validity" class="form-control @error('validity') is-invalid @enderror" value="{{ old('validity', $attribute->validity) }}" step="1">
                                    @error('validity')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="status" id="status" class="form-control select2 @error('status') is-invalid @enderror">
                                        ...
                                        <option value="{{ $status }}" {{ old('status', $attribute->status) == $status ? 'selected' : null }}>{{ Str::title($text) }}</option>
                                        @endforeach
                                    </select>
                                    @error('status')
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="unit_price" id="unit_price" class="form-control @error('unit_price') is-invalid @enderror uprice-input" value="{{ old('unit_price', $default_price->unit_price) }}" min="0.00" step="0.01">
                                    @error('unit_price')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="discount" id="discount" class="form-control @error('discount') is-invalid @enderror disc-input" value="{{ old('discount', $default_price->discount) }}" min="0.00" step="0.01">
                                    @error('discount')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="discount" id="discount" class="form-control @error('discount') is-invalid @enderror disc-perc-input" disabled value="{{ old('discount', $default_price->discount_percentage) }}">
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <label for="selling_price" class="col-form-label">{{ __('labels.selling_price') }}</label>
                                    <input type="number" name="selling_price" id="selling_price" class="form-control @error('selling_price') is-invalid @enderror sale-price-input" disabled value="{{ old('selling_price', $default_price->selling_price) }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="slot_type" id="slot_type" class="form-control select2 @error('slot_type') is-invalid @enderror">
                                        ...
                                        <option value="{{ $type }}" {{ old('slot_type', $attribute->slot_type) == $type ? 'selected' : null }}>{{ Str::title($type) }}</option>
                                        @endforeach
                                    </select>
                                    @error('slot_type')
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="slot" id="slot" value="{{ old('slot', $attribute->slot) }}" class="form-control @error('slot') is-invalid @enderror">
                                    @error('slot')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
