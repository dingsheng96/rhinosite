        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-transparent">
                    <h3 class="card-title">
                        {{ __('modules.edit', ['module' => trans_choice('modules.currency', 1)]) }}
                    </h3>
                </div>

                <form action="{{ route('admin.currencies.update', ['currency' => $currency->id]) }}" method="POST" role="form" enctype="multipart/form-data">
                    @csrf
                    @method('put')
