@extends('admin.layouts.master', ['guest_view' => true, 'body' => 'enduser', 'title' => __('modules.app.register')])
        ...
        <div class="row">
            <div class="col-lg-6 d-inline-flex">
                <div class="login-container">
                    ...
                    <form action="{{ route('admin.register') }}" method="POST" enctype="multipart/form-data" role="form">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="input-group mb-3">
                                    ...
                                    <select name="city" id="city" class="@error('city') is-invalid @enderror city-dropdown" data-selected="{{ old('city') }}" data-city-route="{{ route('admin.data.countries.country-states.cities', ['__FIRST_REPLACE__', '__SECOND_REPLACE__']) }}">
