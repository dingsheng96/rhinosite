                            ...
                            <div class="col-7 col-md-9">
                                <div class="tab-content" id="vert-tabs-tabContent">
                                    ...
                                    <div class="tab-pane text-left fade show" id="vert-tabs-about" role="tabpanel" aria-labelledby="vert-tabs-about-tab">
                                        ...
                                        <textarea name="about" class="summernote-plain" id="aboutsummernote">{{ old('about', $merchant->userDetail->about) }}</textarea>
                                        <label for="about_service" class="col-form-label">{{ __('labels.about_service') }} </label>
                                        <textarea name="about_service" class="summernote-plain" id="aboutsummernote">{{ old('about_service', $merchant->userDetail->aboutservice) }}</textarea>
                                        <label for="about_team" class="col-form-label">{{ __('labels.about_team') }} </label>
                                        <textarea name="about_team" class="summernote-plain" id="aboutsummernote">{{ old('about_team', $merchant->userDetail->team) }}</textarea>
                                        <label for="about_other" class="col-form-label">{{ __('labels.about_other') }} </label>
                                        <textarea name="about_other" class="summernote-plain" id="aboutsummernote">{{ old('about_other', $merchant->userDetail->other) }}</textarea>
                                    </div>
