                ...
                <div class="login-container">
                    ...
                    <form action="{{ route('register') }}" method="POST" enctype="multipart/form-data" role="form">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="phone" id="phone" class="@error('phone') is-invalid @enderror" placeholder="Eg: 60123456789">
                            @error('phone')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="d-flex align-items-start">
                            <input type="checkbox" id="agree" name="agree" class="mt-2">
                            <div class="col mb-5 mt-1">
                                <label class="login-text" for="agree" class="mb-0">{!! __('app.register_agreement') !!}</label>
                            </div>
                        </div>

                        <button type="submit" href="{{ route('register') }}" class="btn btn-black w-100 ml-0 mb-3">{{ __('app.register_btn_submit') }}</button>
