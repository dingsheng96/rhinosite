        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-transparent">
                    <h3 class="card-title">{{ __('modules.edit', ['module' => trans_choice('modules.submodules.member', 1)]) }}</h3>
                </div>
                ...
                <form action="{{ route('users.merchants.update', ['merchant' => $merchant->id]) }}" method="post" role="form" enctype="multipart/form-data">
                    ...
                    <div class="card-footer bg-transparent text-md-right text-center">
                        <a href="{{ route('users.merchants.index') }}" role="button" class="btn btn-light mx-2">
