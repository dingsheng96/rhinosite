        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-transparent">
                    <h3 class="card-title">{{ __('modules.edit', ['module' => trans_choice('modules.submodules.registration', 1)]) }}</h3>
                </div>

                <form action="{{ route('users.registrations.update', ['registration' => $registration->id]) }}" method="post" role="form" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="status" id="status" class="form-control select2 @error('status') is-invalid @enderror">
                                        ...
                                        <option value="{{ $index }}" {{ old('status', $registration->status) == $index ? 'selected' : null }}>{{ $status }}</option>
                                        @endforeach
                                    </select>
                                    @error('status')
                    ...
                    <div class="card-footer bg-transparent text-md-right text-center">
                        <a href="{{ route('users.registrations.index') }}" role="button" class="btn btn-light mx-2">
