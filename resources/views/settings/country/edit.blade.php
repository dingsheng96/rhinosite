        ...
        <div class="col-12 col-md-5">
            <div class="card">
                <div class="card-header bg-transparent">
                    <h3 class="card-title">{{ __('modules.edit', ['module' => trans_choice('modules.submodules.country', 1)]) }}</h3>
                </div>

                <form action="{{ route('settings.countries.update', ['country' => $country->id]) }}" method="POST" role="form" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name', $country->name) }}" class="form-control ucfirst @error('name') is-invalid @enderror" required>
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <select name="currency" id="currency" class="form-control select2 @error('currency') is-invalid @enderror" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="dial" name="dial" value="{{ old('dial', $country->dial_code) }}" class="form-control @error('dial') is-invalid @enderror" placeholder="Eg: 60, 61" required>
                            @error('dial')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="card-footer bg-transparent text-md-right text-center">
                        <a role="button" href="{{ route('settings.countries.index') }}" class="btn btn-light mx-2 btn-rounded-corner">
...
@include('settings.country.country_state.create')
