@extends('merchant.layouts.master', ['parent_title' => trans_choice('modules.project', 2), 'title' => __('modules.edit', ['module' => trans_choice('modules.project', 1)])])
    ...
    <div class="row">
        <div class="col-12">
            <div class="card shadow">
                ...
                <form action="{{ route('merchant.projects.update', ['project' => $project->id]) }}" method="post" enctype="multipart/form-data" role="form">
                    @csrf
                    @method('put')
                                            ...
                                            <div class="col-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="country_state" id="country_state" class="form-control select2 @error('country_state') is-invalid @enderror country-state-dropdown city-filter"
                                                        data-selected="{{ old('country_state', $project->address->city->countryState->id ?? null) }}" data-country-state-route="{{ route('merchant.data.countries.country-states', ['__REPLACE__']) }}">
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                                    ...
                                                                                    <a role="button" href="#" class="dropdown-item" title="{{ __('labels.delete') }}" data-toggle="modal"
                                                                                        onclick="event.preventDefault(); deleteAlert('{{ __('messages.confirm_question') }}', '{{ __('messages.delete_info') }}', '{{ route('merchant.projects.media.destroy', ['project' => $project->id, 'medium' => $image->id]) }}')">
