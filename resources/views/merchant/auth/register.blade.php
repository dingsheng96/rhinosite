                ...
                <div class="login-container">
                    ...
                    <form action="{{ route('merchant.register') }}" method="POST" enctype="multipart/form-data" role="form">
                        ...
                        <div class="input-group mb-3">
                            <p class="login-text">{{ __('labels.company_name') }} <span class="text-danger">*</span></p>
                        ...
                        <div class="input-group mb-3">
                            <p class="login-text">{{ __('labels.address_2') }}</p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="input-group mb-3">
                                    ...
                                    <select name="city" id="city" class="@error('city') is-invalid @enderror city-dropdown" data-selected="{{ old('city') }}" data-city-route="{{ route('merchant.data.countries.country-states.cities', ['__FIRST_REPLACE__', '__SECOND_REPLACE__']) }}">
