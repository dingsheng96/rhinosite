    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form action="{{ route('merchant.ads-boosters.store') }}" method="POST" role="form" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <select name="project" id="project" class="form-control select2 @error('project') is-invalid @enderror project-dropdown" data-merchant-project-route="{{ route('merchant.data.merchants.projects', '__REPLACE__') }}">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" id="date_from" name="date_from" class="form-control ads-date-picker @error('date_from') is-invalid @enderror" placeholder="yyyy-mm-dd" data-ads-date-filter-route="{{ route('merchant.data.ads.unavailable-date', ['ads' => '__REPLACE__']) }}"
                    ...
                    <div class="card-footer bg-transparent text-md-right text-center">
                        <a role="button" href="{{ route('merchant.ads-boosters.index') }}" class="btn btn-light mx-2 btn-rounded-corner">
