...
<div class="container" style="padding-top: 5rem; padding-bottom: 5rem; min-height:80vh;">
        ...
        <div class="col-12 col-md-3 my-3">
            <div class="card shadow-lg h-100 border">
                ...
                <div class="card-footer border-0 bg-transparent pt-3 pb-5 text-center">
                    ...
                    @if (optional($user->active_subscription)->subscribable_id == $plan->id && optional($user->active_subscription)->subscribable_type == get_class($plan))
                    ...
                    <form action="{{ route('merchant.subscriptions.store') }}" method="post" role="form" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="plan" value="{{ base64_encode(json_encode(['id' => $plan->id, 'class' => get_class($plan), 'trial' => $plan->trial_mode])) }}">
