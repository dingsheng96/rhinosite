@extends('merchant.layouts.master', [ 'title' => trans_choice('modules.order', 2)])
        ...
        <div class="col-12">
            <div class="invoice p-3 mb-3">
                ...
                <div class="row no-print">
                    <div class="col-12">
                        <a href="{{ route('merchant.orders.index') }}" role="button" class="btn btn-light btn-rounded-corner float-right">
