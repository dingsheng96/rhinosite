    ...
    <div class="row mb-4">
        ...
        <div class="col-lg-3 col-12">
            <div class="small-box bg-info">
                ...
                <a href="{{ route('merchants.index') }}" class="small-box-footer">{{ __('labels.more_info') }} <i class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-12">
            <div class="small-box bg-success">
                ...
                <a href="{{ route('members.index') }}" class="small-box-footer">{{ __('labels.more_info') }} <i class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-12">
            <div class="small-box bg-purple">
                ...
                <a href="{{ route('transactions.index') }}" class="small-box-footer">{{ __('labels.more_info') }} <i class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-12">
            <div class="small-box bg-orange">
                ...
                <a href="{{ route('projects.index') }}" class="small-box-footer">{{ __('labels.more_info') }} <i class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
    </div>
            ...
            <div class="card card-body px-0 bg-transparent shadow-none">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <a href="{{ route('ads-boosters.index') }}" class="float-right">{{ __('labels.view_all') . ' >' }}</a>
                    </div>
                </div>
