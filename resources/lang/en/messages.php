...
return [
    ...
    'upload_image_rules' => '{1} <li>Only :extensions file type allowed.</li><li>Total file size must be not more than :maxsize.</li><li>Maximum file dimension: :dimension px.</li>|{2,} <li>Only total of :maxfiles files allowed.</li><li>Only :extensions file type allowed</li><li>Total file size must be not more than :maxsize.</li><li>Maximum file dimension: :dimension px.</li>',
